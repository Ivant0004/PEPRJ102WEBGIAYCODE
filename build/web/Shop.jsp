...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/ShoesStore/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/ShoesStore/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/ShoesStore/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/ShoesStore/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorWhite(){
        $.ajax({
            url: "/ShoesStore/searchAjaxColorWhite",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorGray(){
        $.ajax({
            url: "/ShoesStore/searchAjaxColorGray",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlack(){
        $.ajax({
            url: "/ShoesStore/searchAjaxColorBlack",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorYellow(){
        $.ajax({
            url: "/ShoesStore/searchAjaxColorYellow",
            type: "get", //send it through get method
            data: {
